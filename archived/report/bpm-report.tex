...
\setlength{\cftbeforesecskip}{0.02in}
...
\begin{figure}[b]
\begin{center}
% \includegraphics[scale=.26]{../figures/vector/1-tree-0.pdf}
\includegraphics[scale=.26]{../figures/vector/1-tree-1.pdf}
% \includegraphics[scale=.26]{../figures/vector/1-tree-2.pdf}
...
% \includegraphics[scale=.26]{../figures/vector/1-tree-5.pdf}
\end{center}
...
\noindent {\bf Data representation and program language} \\
\noindent We represent data in terms of an algebraic data type, which gives us a way to form initial programs using the type constructors. Our language for programs consists of type constructors, lambda abstraction, and additional operators. This language is probabilistic, hence programs correspond to distributions on observations. Program structure corresponds to regularities in the observations.

\vskip .8em

\noindent {\bf Search objective: Posterior probability of probabilistic programs} \\
\noindent The objective for our search through program space is the posterior probability of a program given the observed data. This posterior decomposes into a prior based on program length and into a likelihood that we estimate using selective model averaging.

\vskip .8em

\noindent {\bf Search moves: Program transformations} \\
\noindent We describe two types of program transformation that we use as search moves: abstraction and deargumentation. Both transformations collapse program structure, which often increases prior probability of the program and improves generalization to unobserved data.

\vskip .8em

\noindent {\bf Search strategy: Beam search} \\
...
\begin{figure}[t]
  \begin{minipage}{.7\textwidth}
    \lstinputlisting[boxpos=b]{treedata.ss}
  \end{minipage}    
...
\thisfloatsetup{capposition=beside,capbesideposition={top,outside},facing=no}
\begin{figure}[t]
...
% \texttt{[(+ (+ 2 2) (- 2 5)), (+ 2 2)]} with the abstraction \texttt{(define (F1 V1) (+ V1 V1))}. Here, the refactored expression is \texttt{(+ (F1 2) (- 2 5))}, which is shorter than \texttt{(+ (+ 2 2) (- 2 5))}.}.  
...
\begin{figure}
  \subfigure[Samples from the original program.]{
    \includegraphics[scale=.26]{../figures/vector/4-2-1-noisyprog-pre-0.pdf}
    \includegraphics[scale=.26]{../figures/vector/4-2-1-noisyprog-pre-1.pdf}
    \includegraphics[scale=.26]{../figures/vector/4-2-1-noisyprog-pre-2.pdf}
  ...
  \subfigure[An argument with values of uniform color has been replaced with a stochastic choice.]{
  ...
  \subfigure[An argument with non-uniform values has been replaced with a stochastic choice.]{
...
\begin{figure}
  \subfigure[Samples from the original program.]{
    \includegraphics[scale=.26]{../figures/vector/4-2-2-mergeprog-pre-0.pdf}
    \includegraphics[scale=.26]{../figures/vector/4-2-2-mergeprog-pre-1.pdf}
    \includegraphics[scale=.26]{../figures/vector/4-2-2-mergeprog-pre-2.pdf}
  ...
  \subfigure[Two arguments with similar instantiations have been merged.]{
  ...
  \subfigure[Two arguments with dissimilar instantiations have been merged.]{
...
\begin{figure}
  \subfigure[Samples from the original program.]{
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-2.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-3.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-4.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-5.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-6.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-7.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-pre-8.pdf}
    \label{fig:rec-orig}
    }
  \subfigure[Samples from the transformed (recursive) program.]{
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-post-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-post-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/4-2-3-recursion-post-2.pdf}
...
%% give example of inferred compression using noisy data constructors
...
\begin{figure}
  \subfigure[Samples from the original program.]{
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-data-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-data-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-data-2.pdf}
    ...
    \subfigure[Samples from the induced program.]{
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-induced-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-induced-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-1-single-color-flower-induced-2.pdf}
...
The program below generates ten ``flower'' instances that are roughly the same  color.
\begin{lstlisting}[mathescape=true]
(define (flower shade)
...
(repeat 10 ($\lbda$ () (flower 20)))
\end{lstlisting}
We create an initial program that represents these ten flowers using data incorporation and then compress it (result shown below).  We learn a function \texttt{F1} that takes no arguments and creates a flower with petals that are similar in color. The system parameters were $\alpha=1$, beam width $1$, and depth $10$.
\begin{lstlisting}[mathescape=true]
(begin
  (define F2
    ($\lbda$ (V5)
...
We use a program similar to the previous one to generate ten ``flower'' instances, some of which have mostly red petals, some mostly green.
\begin{lstlisting}[mathescape=true]
(define (flower shade)
  (node (data (color (gaussian 0 25)) (size .3))
        (petal shade)
...
(repeat 10 ($\lbda$ () (flower (if (flip) 100 220))))
\end{lstlisting}
% $\includegraphics[scale=.35]{../figures/paramPartsData.pdf}$
Bayesian program merging results in the program shown below. The abstraction \texttt{F2} corresponds to \texttt{petal} and \texttt{F1} corresponds to \texttt{flower}.  System parameters: $\alpha=1$, beam width $1$, and depth $10$.
\begin{lstlisting}[mathescape=true]
(begin
  (define F2
    ($\lbda$ (V5)
  ...
  (define F1
    ($\lbda$ (V2)
      (($\lbda$ (V1)
       ...
       V2)))
  ($\lbda$ ()
    (uniform-choice (F1 91.0) (F1 85.0) (F1 254.0) (F1 234.0) (F1 82.0)
                    (F1 243.0) (F1 104.0))))
\end{lstlisting}
...
\begin{figure}
  \subfigure[Samples from the original program.]{
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-data-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-data-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-data-2.pdf}
    ...
    \subfigure[Samples from the induced program.]{
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-induced-0.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-induced-1.pdf}
    \includegraphics[scale=.2]{../figures/vector/6-2-multiple-color-flower-induced-2.pdf}
...
\begin{figure}
  \subfigure[Samples from the original program.]{
%    \includegraphics[scale=.14]{../figures/vector/6-3-recursion-data-0.pdf}
    \includegraphics[scale=.14]{../figures/vector/6-3-recursion-data-1.pdf}
...
%    \includegraphics[scale=.14]{../figures/vector/6-3-recursion-data-9.pdf}    
    \label{fig:exp-simple-recursion-data}
    }
    \qquad
    \subfigure[Samples from the induced program.]{
%    \includegraphics[scale=.14]{../figures/vector/6-3-recursion-induced-0.pdf}
...
%    \includegraphics[scale=.14]{../figures/vector/6-3-recursion-induced-9.pdf}    
...
(define (petal shade)
  (node (data (color (gaussian shade 25)) (size .3))))
\end{lstlisting}
% $\includegraphics[scale=.4]{../figures/vineData.pdf}$
In the induced code below, \texttt{F1} roughly corresponds to \texttt{vine}. 
%and is passed a single color for the flower parts. The size has been fixed within \texttt{F1}, \texttt{F2} corresponds to the data part of the flower.
\begin{lstlisting}[mathescape=true]
(begin
...
\begin{figure}
  \subfigure[A sample from the original program.]{
    \includegraphics[scale=.14]{../figures/vector/6-4-vine-data-7.pdf}
    \label{fig:exp-vine-data}
    }
    \qquad \quad
    \subfigure[Samples from the induced program. A single observation is sufficient for the induction of a recursive program.]{
%     \includegraphics[scale=.14]{../figures/vector/6-4-vine-induced-0.pdf}
%    \includegraphics[scale=.14]{../figures/vector/6-4-vine-induced-1.pdf}
%    \includegraphics[scale=.14]{../figures/vector/6-4-vine-induced-2.pdf}
...
%    \includegraphics[scale=.14]{../figures/vector/6-4-vine-induced-5.pdf}
...
\begin{figure}
    \subfigure[Observations used for program induction.]{
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-data-0.pdf}
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-data-1.pdf}
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-data-2.pdf}
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-data-3.pdf}
    \label{fig:exp-tree-data}        
    }
    \quad \quad
    \subfigure[Samples from the induced program.]{
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-0.pdf}
    \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-1.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-2.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-3.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-4.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-5.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-6.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-7.pdf}
    ...
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-11.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-12.pdf}
    % \includegraphics[scale=.16]{../figures/vector/6-5-tree-induced-13.pdf}
