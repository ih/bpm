...
\begin{figure}[h]
  \subfloat{\lstinputlisting[boxpos=b]{treedata2.ss}}
  \hspace{40pt} %
  \subfloat{
...
\begin{figure}[t]
  ...
  \hspace{40pt} %
  \subfloat{
    \includegraphics[scale=1]{../figures/initData.pdf}
  }
...
\begin{figure}[b]
\begin{center}
\includegraphics[scale=.30]{../figures/expressionTree.pdf}
...
%% show how noisy data constructors allow concise representation
...
%% say that this allows us to infer when to use them
...
To generate observations for an example of inducing noisy data constructors, we use the following program to sample trees. Each tree consists of three nodes with small variance in the color of the third node.
\begin{lstlisting}[mathescape=true]
...
(begin
  ...
  (lambda () (uniform-choice (F1) (F3) (F1) (F1) (F1))))
