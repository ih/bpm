...
\begin{lstlisting}[mathescape=true]
(begin (define F3 (lambda () (F2 100 0.1)))
    (define F2
      (lambda (V4 V5)
...
\end{lstlisting}
\section{Discussion}
We presented an approach to creating generative models from data called Bayesian program merging.  The main ideas were to rerepresent data as a program and then frame finding regularities in the trasformed data as identifying repeated computation in the program.   Finding repeated computation was performed through program transformations that merged the structure of a program.  The sequences of transformations made while searching were guided using the posterior of the program.  
