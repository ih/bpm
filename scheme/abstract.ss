...
(library (abstract)
         (export true-compressions all-compressions compressions test-abstraction-proposer abstraction-move proposal beam-search-compressions beam-compression all-iterated-compressions iterated-compressions inline unique-programs sort-by-size make-dearguments-transformation simple-noisy-number-dearguments uniform-draw-dearguments possible-abstractions shortest-n noisy-number-dearguments same-variable-dearguments)
